...
import org.jesus.authproject.security.filters.JwtValidationFilter;
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) {
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    ...
                    http.requestMatchers("/api/public/**").hasAnyRole("USER", "ADMIN");
                    http.anyRequest().hasAnyRole("ADMIN");
                })
